...
function createBot(id) {
  ...
  return {
    ...
    activeTradeTimers:{}, // contractId -> {remaining, total, timer}
    entryTargets:[],
...
function broadcastBotState(b) {
  broadcast({
    ...
    activeTradeTimers:Object.fromEntries(Object.entries(b.activeTradeTimers||{}).map(([k,v])=>[k,{remaining:v.remaining,total:v.total}])),
...
function handleDerivMessage(b, d) {
  ...
  if(d.msg_type==='buy'){
    ...
    startTradeTimer(b, b.currentContractId, b.cfg.durationMins*60);
